...
class Matches extends Constraint
{
    ...
    private function assertEquals($expected, $actual, $keyPath): void
    {
    ...
    private function assertMatches($expected, $actual, $keyPath = ''): void
    {
    ...
    private function assertMatchesArray(BSONArray $expected, $actual, $keyPath): void
    {
    ...
    private function assertMatchesDocument(BSONDocument $expected, $actual, $keyPath): void
    {
    ...
    private function assertMatchesOperator(BSONDocument $operator, $actual, $keyPath): void
    {
